...
<div class="art-content-layout layout-item-0">
    ...
    <div class="art-layout-cell layout-item-1" style="width: 33%"><?php if (false === theme_print_sidebar('footer-1-widget-area')) { ?>
        <p><a href="http://www.unn.ru/" style="font-family: Verdana;"><span style="color: #FFFFFF;">Хостинг для сайта предоставлен</span></a></p><p><span style="font-family: Verdana; color: #FFFFFF;"><a href="http://www.unn.ru/" style="font-family: Verdana;"><span style="color: #FFFFFF;">&nbsp;ННГУ им. Н.И. Лобачевского</span></a></span><span style="color: #FFFFFF;"></span></p><p><br></p><p class="MsoNormal"><span style="color: rgb(255, 255, 255); font-family: Verdana;">© МАОУ "Лицей №28 им. акад. Б.А.Королёва"</span></p><p class="MsoNormal"><span style="color: rgb(255, 255, 255); font-family: Verdana;">2020</span></p><p><br></p><p><span style="color: #FFFFFF;"></span></p>
    <?php } ?></div><div class="art-layout-cell layout-item-2" style="width: 34%"><?php if (false === theme_print_sidebar('footer-2-widget-area')) { ?>
    ...
    <?php } ?></div><div class="art-layout-cell layout-item-1" style="width: 33%"><?php if (false === theme_print_sidebar('footer-3-widget-area')) { ?>
        <p>
